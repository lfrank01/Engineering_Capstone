...
* A violin bow requires many aspects of the hand for optimal performance. To create a more comfortable design for Ramisi, a pronation and supination mechanism would be ideal and have to be designed. 
...
* The slideshow presentation was successful and effective
...
### What new issues were discovered?
* Not a specifically new issue, but we’ve realized that we must work as fast as possible so that our clients can have the resources they need as soon as they can. There is no fixed deadline for the capstones, just that the designs work and are available as soon as possible. 

### What went well?
* We’ve made good progress by learning what the needs of our clients are and what they need to have, and what would be nice for Alex and  Ramisi. 
* We have successfully kept the line of communication open with Elisabeth. 
...
### What new resources did you find?
* Elle Polifka is a great resource for learning how the mechanics of violin work. Elle taught Luke the basic form of violin 
* [E-NABLE Prosthetics Design](https://enablingthefuture.org) as a great resource for model prosthetic hands. They have a DIY prosthetic creation page that looks very helpful

### What new issues were discovered?
* We do not yet know the specific material of thermoplastic that Elisabeth gave us. Thus, we had to experiment with a heat gun to try to find the right temperature for molding at; we found a rough estimate (~460 degrees Fahrenheit)
...
* Applying the thermoplastic to the skin when molding. If done correctly, we do not believe it will burn, but we will obviously have to experiment with the best way of applying the thermoplastics 

### What went well?
* We successfully managed to mold thermoplastic material using the heat gun and mold it
...
### What was difficult?
* Having to ask Elisabeth Scharf about certain things, like what material of thermoplastic we have and how she applied heat to the thermoplastics (like a furnace or heat gun) requires a bit of patience because of the space-time gap between us. We sometimes have to divert our focus for a bit while waiting on a key bit of insight
...
* To try to make a mold of Luke's hand for the experience
* To use our own cookie tray (Angus's) since we couldn't get one from the cafeteria 

### What new resources did you find?
* A cookie tray (Angus's), a heat plate (Sigma Lab's), and a heat measuring device (thermometer from the Biology classroom)
...
### What new issues were discovered?
* A very key problem with using a heat plate with water is that it takes around 10-20 minutes to heat up to a close to insufficient temperature. We got the heat plate to heat the water up to ~60 degrees F, but this temperature needed to be more to harness the thermoplastics' molding capabilities.
* Molding can be challenging. There's a short time until cooling, meaning the molding process has to happen quickly.
* There are pressure points we must be mindful of, like the ulnar styloid on the wrist. The design has to be shaped or sometimes cut to avoid rubbing on these possible pressure points like the ulnar styloid, which requires a good molding job (which we will get better at with experience)

### What went well?
* We made use of the time we had and got to try out the heat plate method, determining that water was likely our best bet for making the thermoplastic moldable, although probably not with a heat plate
...
* Luke was away in Boston on Friday, and on Thursday, Angus wasn't there because it was a weirdly-scheduled PSAT day. Thus, we had less time to work
...
### What is your plan for next week?
* Elisabeth Scharf will be in town next week, and we're planning to work with her for a class period so that she can teach us the skills she learned last year
 ...
 * Using velcro straps on each side to connect the two sides
...
### What went well?
* We successfully made a rough mold for Elle Pollifka's hand that also had a space where the violin bow could be anchored. However, we forgot to take into account how the bowstring hair would press against the thermoplastic and thus had to rethink our initial mold

### What was difficult?
* Doing the molding in enough time. The water for the thermoplastic was usually not hot enough
* Submerging an already formed mold for the redesign. We put the hot water in the cookie tray to heat the flat thermoplastic material, but it takes more work to submerge a more complex shape in a flat container. We may need to use a beaker
...
* Identifying mold pressure points and fixing these areas with either sandpaper or making smooth cuts 
* Communicating with Alex about our plans for the prosthetic hand. Working on one project at a time will be the best way to have successful results, but this means that Alex's project will come later in the year. We want to communicate this to her to be clear about our schedule and constraints
...
* We emailed Alex about our plans and schedule but haven't received a response yet.
...
* We used Mr. Miller's sharp scissors to cut the thermoplastics, which is most likely the best thing we have to cut the thermoplastic.

### What new issues were discovered? 
* We don't have the same lunch as Ramisi, so on non-block days, we have very little time to do any testing. 

### What went well?
* We were able to get our first model for Ramisi, which is super exciting and a great strive towards the final. 

### What was difficult?
* We only had two days for the week, but we were extremely productive, and it makes us think about how much more we could've gotten done if we had a full week to work. 

### What is your plan for next week?
* Create a much better model for Ramisi, with much more definition than the last.
...
### What decisions were made?
* We decided that we'll make a temporary bow adapter for Ramisi's so she can play by next week. 
* We'll try to have the final mold with in a month. 

### What went well?
* We made great strides in having something for Ramisi to play with and learned a lot about what works for her and what hurts. 
...
### What new resources did you find?
* No new resources necessarily, but we did decide that we wanted to talk to Ms. Hite
* Another resource that we've already been aware of, but Adrian Anantawan's violin adapter might be a design worth considering

### What new issues were discovered?
* We already knew from the previous week that Ramisi's current mold was too tight, but we also learned that we need to change the orientation of the mold to enable more horizontal movement

### What went well?
* We successfully emailed Ms. Hite and organized times to meet with Ramisi
...
* Experimenting with the idea of an Anantawan-inspired design
...
### What decisions were made?
* We've decided to change our current design. Having the hand orientation be vertical, as opposed to horizontal (the natural way), is uncomfortable and ineffective. We should have thought more about this when making our design
* To use a cup instead of a cookie tray. The cup makes it much easier to cover all surface area of the mold
...
### What was difficult?
* It's quite frustrating the pace the project is going. Obviously, our client directly benefits from us making a successful design, so it feels like a disservice to not be doing the best we can. 
...
* We did brainstorming on both a Google Doc and a piece of paper
* We debated reaching out to Dr. Hite in case she was simply busy, but because she has not responded, we will likely send a second follow-up over the weekend or next week
...
### What new issues were discovered?
* The tea kettle we were heating up our water with broke after Luke dropped it while taking it home after the break, and his dad threw it out because the top was cracked. In turn, we have to look for a new tea kettle, and because we didn't have one this week, we couldn't use thermoplastics and so we used basic supplies
* Not necessarily new, but the delay in communication between Dr. Hite and us remains a challenge

### What went well?
* A lot went well -- we used all the time we had, didn't wait around, and successfully prototyped
* Luke was out of class Friday, but Angus still was productive and finished the working prototype
* We effectively followed a design process by finding out what we had to change, how to do it, and then doing it.

### What was difficult?
* We didn't have Dr. Hite's input on our work because she hasn't responded in the past week or so
* We didn't have thermoplastics
* We didn't have a tea kettle

### What is your plan for next week?
* To create our model out of refined materials (thermoplastics, wood if necessary, adhesive wrap/velcro, etc.)
...
### Below are some pictures of our design blueprint and a clamp design from an inspirational [idea](https://patient-innovation.com/post/2085)
